...
require 'funtion.php';
$dafdo = query("SELECT * FROM dosenft");

if (isset($_POST['cari'])) {
  $dafdo = caridosen($_POST['keyword']);
}
?>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 pd-5 pt-5 ">
      ...
      <table class="table table-striped" style="width: 800px;">
        ...
        <tbody>
          <?php $no = 1;  ?>
          <?php foreach ($dafdo as $dado) : ?>
            <tr>
              <th scope="row"><?php echo $no; ?></th>
              <td><?php echo $dado['nidn']; ?></td>
              <td><?php echo $dado['nama']; ?></td>
              <td><?php echo $dado['email']; ?></td>
              <td><a href="detaildosen.php?id=<?= $dado['id']; ?>" class="btn btn-warning" role="button">detail</a></td>
            </tr>
            <?php $no++ ?>
          <?php endforeach ?>
        </tbody>
