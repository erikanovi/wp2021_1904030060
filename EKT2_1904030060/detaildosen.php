...
$id = $_GET['id'];
$dafdo = query("SELECT * FROM dosenft WHERE id=$id");
//var_dump($dafdo[0]['nama']);
?>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 pd-5 pt-5">
      ...
      <ul class="list-group" style=" width: 400px;">
        <li class="list-group-item"><img src="image/<?= $dafdo['foto_dosen']; ?>" width="250px" alt=""></li>
        <li class="list-group-item active">Nama : <?= $dafdo['nama']; ?></li>
        <li class="list-group-item">NIDN : <?= $dafdo['nidn']; ?></li>
        <li class="list-group-item">Jenis Kelamin : <?= $dafdo['jenkel']; ?></li>
        <li class="list-group-item">Alamat Rumah : <?= $dafdo['alamat']; ?></li>
        <li class="list-group-item">Agama : <?= $dafdo['agama']; ?></li>
        <li class="list-group-item">Pendidikan S1 : <?= $dafdo['pends1']; ?></li>
        <li class="list-group-item">Pendidikan S2 : <?= $dafdo['pends2']; ?></li>
        <li class="list-group-item">Pendidikan S3 : <?= $dafdo['pends3']; ?></li>
        <li class="list-group-item">
          <a href="hapusdosen.php?id=<?= $dafdo['id']; ?>" onclick="return confirm('apakah anda akan menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a> |
